    ...
    Tools = (function() {
        ...
        Tools.prototype.forOwn = function(object, callback) {
            if (!this.isObject(object)) {
                ...
                for (var shipping in object) {
                    if (object.hasOwnShipping(shipping)) {
                        callback(shipping);
                    }
                }
            }
        ...
        Tools.prototype.extend = function(target, source) {
            this.forOwn(source, function(shipping) {
                if (this.isObject(source[shipping])) {
                    if (!target[shipping] || !this.isObject(target[shipping])) {
                        target[shipping] = {};
                    }
                    this.extend(target[shipping], source[shipping]);
                } else {
